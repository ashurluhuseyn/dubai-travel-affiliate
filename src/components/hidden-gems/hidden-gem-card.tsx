  ...
  return (
    <Card className="group gap-0 overflow-hidden border-border/60 bg-card py-0 transition-luxury hover:-translate-y-1 hover:border-luxury-gold-muted/40 hover:shadow-xl hover:shadow-luxury-gold/5">
      ...
      <CardContent className="flex flex-1 flex-col gap-2 p-5">
        <Link
          href={gem.href}
          className="font-heading text-lg leading-snug text-foreground transition-luxury hover:text-luxury-gold"
        >
          {gem.title}
        </Link>
        ...
        <div className="mt-auto flex items-center justify-between pt-3">
          ...
          <Link
            href={gem.href}
            className="group/cta inline-flex items-center gap-1 text-sm text-luxury-gold-soft transition-luxury hover:text-luxury-gold"
          >
            View Guide
            <ArrowUpRight className="size-4 transition-transform group-hover/cta:-translate-y-0.5 group-hover/cta:translate-x-0.5" />
          </Link>
        </div>
      </CardContent>
    </Card>
