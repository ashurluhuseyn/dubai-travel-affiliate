...
const desertSafariSlug = "desert-safari-dune-bashing";

const desertSafariDetail: ExperienceDetail = {
  slug: desertSafariSlug,
  affiliateUrl: buildAffiliateUrl(desertSafariSlug),
...
/** Reuses the desert safari template for related experience detail routes. */
function createRelatedExperienceDetail(
  slug: string,
  title: string,
  price: string
): ExperienceDetail {
  return {
    ...
    slug,
    title,
    affiliateUrl: buildAffiliateUrl(slug),
    price,
    related: desertSafariDetail.related,
  };
}
...
export const experienceDetails: Record<string, ExperienceDetail> = {
  [desertSafariSlug]: desertSafariDetail,
  "premium-desert-camp": createRelatedExperienceDetail(
    "premium-desert-camp",
    "Premium Desert Camp Experience",
    "$129"
  ),
  "buggy-adventure": createRelatedExperienceDetail(
    "buggy-adventure",
    "Buggy Adventure in Dubai Desert",
    "$169"
  ),
  "quad-biking": createRelatedExperienceDetail(
    "quad-biking",
    "Quad Biking Desert Adventure",
    "$139"
  ),
  "hot-air-balloon": createRelatedExperienceDetail(
    "hot-air-balloon",
